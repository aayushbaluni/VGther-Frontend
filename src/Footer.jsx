...
const Footer = () => {
  return (
    <Box minH={['0','calc(50vh)']} w={'100%'} bgColor={'black'} padding={'10'} display={'flex'} flexDir={['column','row']}>
      ...
      <Link href='https://merchant.razorpay.com/policy/LpQvwLwV81sPcC/privacy' isExternal ><Button variant={'link'} color={'white'}>Privacy Policy</Button></Link>
      <Link href='https://merchant.razorpay.com/policy/LpQvwLwV81sPcC/terms' isExternal ><Button variant={'link'} color={'white'}>Terms and Conditions</Button></Link>
