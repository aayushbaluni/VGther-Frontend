...
const links = [{id:'Sign up',href:"/signup"}, {id:'Login',href:"/login"}, {id:'Join Events',href:"/events"}, {id:'Careers',href:"#"}, {id:'Terms of use',href:"/legal/terms"}, {id:'Privacy policy',href:"/legal/privacy"}];
